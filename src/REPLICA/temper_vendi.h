...
#ifdef COMMAND_CLASS
// clang-format off
CommandStyle(temper/vendi,TemperVendi);
// clang-format on
#else

#ifndef LMP_TEMPER_VENDI_H
#define LMP_TEMPER_VENDI_H

#include "command.h"

namespace LAMMPS_NS {

    class TemperVendi : public Command {
    public:
        TemperVendi(class LAMMPS *);
        ~TemperVendi() override;
